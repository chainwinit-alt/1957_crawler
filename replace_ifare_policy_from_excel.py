        ...
        prepared_rows.append(
            {
                ...
                "OfficeUnitInfo": normalize_text(row.get("OfficeUnitInfo")),
                "OfficeUnitTel": normalize_text(row.get("OfficeUnitTel")),
                ...
                "CompetentAuthority": normalize_text(row.get("CompetentAuthority")),
